  ...
  return (
    <div className="container" style={{ paddingBottom: "60px" }}>
      ...
      <section className="card" style={{ marginBottom: "24px", cursor: "default" }}>
        <h2 className="text-lg md:text-xl font-bold mb-4" style={{ color: "var(--accent-primary)" }}>1. ¿Cómo debe ser el JSON de la IA?</h2>
      ...
      <section className="card" style={{ marginBottom: "24px", cursor: "default" }}>
        <h2 className="text-lg md:text-xl font-bold mb-4" style={{ color: "var(--accent-gym)" }}>2. ¿Cómo cargar los pesos en el Gym?</h2>
        <p style={{ color: "var(--text-secondary)", marginBottom: "12px", lineHeight: "1.6" }}>
      ...
      <section className="card" style={{ marginBottom: "24px", cursor: "default" }}>
        <h2 className="text-lg md:text-xl font-bold mb-4" style={{ color: "var(--accent-cycling)" }}>3. ¿Cómo registrar mi ruta de Bicicleta?</h2>
        <p style={{ color: "var(--text-secondary)", marginBottom: "12px", lineHeight: "1.6" }}>
      ...
      <section className="card" style={{ cursor: "default" }}>
        <h2 className="text-lg md:text-xl font-bold mb-4" style={{ color: "var(--text-primary)" }}>4. ¿Qué representan las métricas?</h2>
        <p style={{ color: "var(--text-secondary)", marginBottom: "12px", lineHeight: "1.6" }}>
